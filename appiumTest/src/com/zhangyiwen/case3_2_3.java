...
public class case3_2_3 extends TestInfo {
...
//		Thread.sleep(3000);
//		driver.findElementByXPath("//android.widget.FrameLayout/android.view.View/android.widget.LinearLayout[2]");//单击流程
//		Thread.sleep(3000);
//		driver.findElementById("com.android.ayplatform:id/more").click();//可找到“委托”的按钮
//		Thread.sleep(3000);
//		driver.findElementByXPath("//hierarchy/android.widget.FrameLayout");//单击“委托”
//		Thread.sleep(3000);
//		driver.findElementById("com.android.ayplatform:id/workbench_head_search").click();//单击搜索
//		Thread.sleep(3000);
//		//搜索“xue”
//		(new TouchAction(driver)).tap(330, 194).perform();
//		(new TouchAction(driver)).tap(505, 1018).perform();
//		(new TouchAction(driver)).tap(353, 1024).perform();
//		(new TouchAction(driver)).tap(512, 771).perform();
//		(new TouchAction(driver)).tap(55, 675).perform();
//		(new TouchAction(driver)).tap(651, 1129).perform();
//		Thread.sleep(3000);
...
//		Thread.sleep(3000);
//		(new TouchAction(driver)).tap(189, 555).perform();//委托内容
//		(new TouchAction(driver)).tap(526, 1013).perform();
//		(new TouchAction(driver)).tap(318, 674).perform();
//		(new TouchAction(driver)).tap(669, 672).perform();
//		(new TouchAction(driver)).tap(661, 675).perform();
//		Thread.sleep(3000);
//		driver.findElementByXPath("//hierarchy/android.widget.FrameLayout/android.widget.FrameLayout");//单击委托框“确定”
//		Thread.sleep(3000);
//		
