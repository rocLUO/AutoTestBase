...
public class case3_2_5 extends TestInfo {
	...
	public void case3_3_1() throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElementById("com.android.ayplatform:id/more").click();//可找到“中断”的按钮
		Thread.sleep(3000);
		driver.findElementByXPath("//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout");//单击“中断”
		Thread.sleep(3000);
		//输入中断理由
		(new TouchAction(driver)).tap(160, 558).perform();
		(new TouchAction(driver)).tap(515, 1013).perform();
		(new TouchAction(driver)).tap(211, 907).perform();
		(new TouchAction(driver)).tap(59, 672).perform();
		(new TouchAction(driver)).tap(652, 1122).perform();
		(new TouchAction(driver)).tap(661, 668).perform();
		Thread.sleep(3000);
