...
public class case3_2_6 extends TestInfo {
	...
	public void case3_3_1() throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElementById("com.android.ayplatform:id/more").click();//可找到“历史记录”的按钮
		Thread.sleep(3000);
		driver.findElementByXPath("//hierarchy/android.widget.FrameLayout");//单击“历史记录”
		Thread.sleep(3000);
