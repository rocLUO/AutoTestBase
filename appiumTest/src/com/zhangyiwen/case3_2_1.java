...
/*
 *@author luopeng
 *Last_Update 2018年4月25日上午9:58:22
 *
 */
public class case3_2_1 extends TestInfo {
	...
	public void case3_2_1() throws InterruptedException {
		...
		/*
		 * Thread.sleep(10000); driver.findElementByXPath(
		 * "//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.support.v4.widget.DrawerLayout/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.widget.FrameLayout/android.view.View/android.widget.LinearLayout[2]/android.support.v4.view.ViewPager/android.widget.RelativeLayout/android.view.View/android.support.v7.widget.RecyclerView/android.widget.RelativeLayout[2]/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.LinearLayout[1]/android.widget.RelativeLayout[1]/android.widget.TextView")
		 * .click(); Thread.sleep(3000); driver.findElementByXPath(
		 * "//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.support.v7.widget.RecyclerView/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[3]/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.EditText")
		 * .click(); Thread.sleep(3000); (new TouchAction(driver)).tap(364,
		 * 781).perform(); Thread.sleep(3000); (new
		 * TouchAction(driver)).tap(507, 778).perform(); Thread.sleep(3000);
		 * (new TouchAction(driver)).tap(659, 674).perform();
		 * Thread.sleep(3000); driver.swipe(400, 1000, 400, 100, 500);
		 * Thread.sleep(3000); driver.findElementById(
		 * "com.android.ayplatform.pre:id/org_add_user_imageView").click();
		 * Thread.sleep(3000);
		 * 
		 * driver.findElementByXPath(
		 * "//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.TextView[1]")
		 * .click(); Thread.sleep(3000); (new TouchAction(driver)).tap(560,
		 * 1109).perform(); (new TouchAction(driver)).tap(636, 888).perform();
		 * (new TouchAction(driver)).tap(544, 785).perform(); (new
		 * TouchAction(driver)).tap(348, 899).perform(); (new
		 * TouchAction(driver)).tap(187, 779).perform(); (new
		 * TouchAction(driver)).tap(489, 1008).perform(); (new
		 * TouchAction(driver)).tap(659, 1113).perform(); Thread.sleep(8000);
		 * System.out.println("duleishizhu"); driver.findElementByXPath(
		 * "//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.LinearLayout[2]/android.view.View[1]/android.support.v7.widget.RecyclerView/android.widget.RelativeLayout/android.widget.RelativeLayout")
		 * .click(); System.out.println("doubi"); Thread.sleep(8000);
		 * System.out.println("duleishizhu"); driver.findElementById(
		 * "//com.android.ayplatform.pre:id/org_search_display_submit").click();
		 * Thread.sleep(8000); System.out.println("doubi");
		 * driver.findElementById(
		 * "com.android.ayplatform.pre:id/flow_detail_submit_Button").click();
		 * Thread.sleep(3000);
		 */
