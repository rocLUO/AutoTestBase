...
public class case3_2_4 extends TestInfo {
	...
	public void case3_3_1() throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElementById("com.android.ayplatform:id/more").click();//可找到“回退”的按钮
		Thread.sleep(3000);
		driver.findElementByXPath("//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout");//单击“回退”
		Thread.sleep(3000);
