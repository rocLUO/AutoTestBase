...
//			Thread.sleep(3000);
//			AppBase.clickXpath(WorkFlow_Copy_Xpath, driver); // 点击抄送
//			// 防止组织架构无法自动加载
//			Thread.sleep(1000);
...
//			Thread.sleep(2000);
//			AppBase.clickXpath(WorkFlow_Enrust_Xpath, driver); // 点击委托
//			// 防止组织架构无法自动加载
//			Thread.sleep(1000);
//			AppBase.swipXY(517, 376, 517, 1761, driver);
//
...
//			Thread.sleep(2000);
//			AppBase.clickXpath(WorkFlow_Copy_Xpath, driver); // 单击抄送
//			Thread.sleep(2000);
...
//			AppBase.clickId("com.android.ayplatform.pre:id/more", driver); // 可找到“抄送”的按钮
//			Thread.sleep(2000);
//			AppBase.clickXpath(WorkFlow_Enrust_Xpath, driver); // 单击抄送
//			Thread.sleep(2000);
//			AppBase.clickId("com.android.ayplatform.pre:id/workbench_head_search", driver); // 单击搜索
//			// 输入法切换
//			Thread.sleep(2000);
