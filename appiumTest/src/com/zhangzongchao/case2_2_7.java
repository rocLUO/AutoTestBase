...
public class case2_2_7 extends TestInfo {
...
//		cap.setCapability("resetKeyboard", true);
	...
	public void case2_2_2() throws InterruptedException {
		...
		//上传图片、照相、@、位置、
				...
				(new TouchAction(driver)).tap(418,695).perform();
				(new TouchAction(driver)).tap(530,380).perform();//选择1张图片
				(new TouchAction(driver)).tap(897,1967).perform();//确定(2/9张)
				driver.findElementByXPath("//android.widget.TextView[@text='所在位置']").click();
				...
				clearId("com.android.ayplatform.release:id/activity_published_talking_alt");//点击@
				clearId("com.android.ayplatform.release:id/item_orgstructure_department_or_job_name");//选择部门
				clearId("com.android.ayplatform.release:id/recycle_list");//选择人员
				driver.findElementByXPath("//android.widget.TextView[@text='确定']").click();
