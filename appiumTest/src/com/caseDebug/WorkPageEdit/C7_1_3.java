 ...
 * Description:
 */
public class C7_1_3 extends TestInfo {
    @Test(description = "附件上传-文件-文档")
    public static void case7_1_3(AppiumDriver Driver) throws InterruptedException {
        try {
            OpenAppList.viewWrokListByProtal(Driver, 4);
            Thread.sleep(2000);

            FileAction.WorkFlowSendFile(Driver, 0, ".1 test send file", 5);
            Thread.sleep(2000);
